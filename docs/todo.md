...
- [ ] 继续推进 audio/clock 主线路：把 H.264 的 FFmpeg/ffplay-style audio serial/master-clock runtime 迁到 H.265/AV1 loop reset；随后把现有 target-fps pacer 切成 video-clock/audio-clock 可选 master，最后接实际音频输出/静音策略。
