...
- [x] 将 H.264/H.265 visible direct smoke 和 CLI 默认输入切到 streaming queue，并停止维护 ready-prefix spool 入口：可见 video runtime 不再保留长 AU payload，剩余 H.264 4K/240 缺口主要落在 codec capability、present pacing/同步或驱动路径，不是 packet retention。
